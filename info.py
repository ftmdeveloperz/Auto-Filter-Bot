...
# Bot information
API_ID = environ.get('API_ID', '22141398')
if len(API_ID) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002472427519').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002428720041')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002282331890')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://ftm:ftm@cluster0.cntf9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/ftmbotzx")
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/ftmbotzx")
...
QUALITY = [quality.lower() for quality in environ.get('QUALITY', '360p 480p 720p 1080p 2160p 2K 4K 8K').split()]
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", script.IMDB_TEMPLATE)
FILE_CAPTION = environ.get("FILE_CAPTION", script.FILE_CAPTION)
SHORTLINK_URL = environ.get("SHORTLINK_URL", "modijiurl.com")
SHORTLINK_API = environ.get("SHORTLINK_API", "79a8621baf4ba2a396eed551eb5d89634d64998f")
VERIFY_EXPIRE = int(environ.get('VERIFY_EXPIRE', 604800)) # Add time in seconds
WELCOME_TEXT = environ.get("WELCOME_TEXT", script.WELCOME_TEXT)
INDEX_EXTENSIONS = [extensions.lower() for extensions in environ.get('INDEX_EXTENSIONS', 'mp4 mkv 3gp').split()]
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002291621486")
